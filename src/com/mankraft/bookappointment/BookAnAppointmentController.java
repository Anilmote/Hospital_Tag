...
import com.mankraft.jdbcTemplate.PatientJDBCTemplate;
...
public class BookAnAppointmentController {
	...
	public String processSubmit(
		...
		} else {status.setComplete();
		try {
			patientJDBCTemplate.populatePatientAppoinmentData(appointment);
		}catch(Exception e) {
			e.printStackTrace();
		}
		//form success
		return "AppointmentSucceed";}
	}
