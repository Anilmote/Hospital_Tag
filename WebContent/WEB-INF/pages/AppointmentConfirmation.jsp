...
<head>
 ...
 <style>
  h4{color:white;}
  .name{height:30px;width:50%;margin-left:50px}
...
<div class="form-group row">
  <label for="dob1" class="col-xs-2 col-form-label">D.O.B:</label>
  <div class="col-xs-10">
...
<input type="submit" value="AppointmentConformation"/>
</div>
</form>
</div>
<!------- copy right------------->
    ...
    <div class="col-md-12" style="height:70px;background-color:#197681;text-align:center;padding:18px">
     <h6 style="color:white;">COPYRIGHT @ 2016 CHINNAM RAJU HOSPITALS.  ALL RIGHTS RESERVED</h6>
